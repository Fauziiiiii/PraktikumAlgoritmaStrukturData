...
public class MahasiswaDemo21 {
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("6. Menghitung Total Tugas");
            ...
            switch (pilih) {
                ...
                case 4:
                    Mahasiswa21 lihatPertama = stack.peekTugasPertama();
                    if(lihatPertama != null){
                        System.out.println("Tugas pertama dikumpulkan oleh " + lihatPertama.nama);
                    }
                    break;
                ...
                case 6:
                    System.out.print("Total tugas yang dikumpulkan: ");
                    int total = stack.hitungTotalTugas();
                    if(total != 0){
                        System.out.println(total + " tugas");
                    }
                    System.out.println();
                    break;
